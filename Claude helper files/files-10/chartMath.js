 ...
 */
export function pointOnCircle(centerX, centerY, radius, longitude) {
 ...
 */
export function createArcPath(centerX, centerY, innerRadius, outerRadius, startLongitude, endLongitude) {
  const startInner = pointOnCircle(centerX, centerY, innerRadius, startLongitude);
  const endInner = pointOnCircle(centerX, centerY, innerRadius, endLongitude);
  const startOuter = pointOnCircle(centerX, centerY, outerRadius, startLongitude);
  const endOuter = pointOnCircle(centerX, centerY, outerRadius, endLongitude);
